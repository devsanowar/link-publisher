...
class AdminController extends Controller
{
    ...
    public function filterDashboardData(Request $request)
    {
        ...
        $order_count = WebsiteOrder::whereBetween('created_at', [$fromDate, $toDate])->count();
        $total_order_amount = WebsiteOrder::whereBetween('created_at', [$fromDate, $toDate])->sum('total_price');
        ...
        $status_counts = WebsiteOrder::select('status', DB::raw('count(*) as count'))
