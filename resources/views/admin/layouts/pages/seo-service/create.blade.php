...
@section('title', 'Create Seo Service')
@push('styles')
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 mt-3">
                <div class="card">
                    <div class="card-header">
                        <h4 class="">Create Seo Service<span><a href="{{ route('seo_service.index') }}" class="btn btn-primary text-white text-uppercase text-bold right"> All Seo Services </a></span></h4>
                    </div>
                    <div class="body">
                        <form id="addSeoServiceForm" class="form-horizontal" method="POST">
                            @csrf
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            $('#addSeoServiceForm').on('submit', function(e) {
                e.preventDefault();
                let formData = $(this).serialize();

                $.ajax({
                    type: 'POST',
                    url: "{{ route('seo_service.store') }}",
                    data: formData,
                    success: function(response) {
                        $('#addSeoServiceForm')[0].reset();
